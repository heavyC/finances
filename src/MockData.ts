...
export const MockTransactionsData = [
    { txn_id: "1", txn_type: "expense", txn_title: "Starbucks", txn_amount: 17.95, date_posted: getMockDate(1, 4), date_updated: getMockDate(0, 4) },
    { txn_id: "2", txn_type: "expense", txn_title: "Peet's", txn_amount: 137.90, date_posted: getMockDate(0, 4), date_updated: getMockDate(0, 4) },
    { txn_id: "3", txn_type: "expense", txn_title: "Amazon", txn_amount: 198.00, date_posted: getMockDate(2, 0), date_updated: getMockDate(1, 9) },
    { txn_id: "4", txn_type: "income", txn_title: "Paycheck", txn_amount: 3198.00, date_posted: getMockDate(7, 0), date_updated: getMockDate(1, 4) },
    { txn_id: "5", txn_type: "expense", txn_title: "Star Bird", txn_amount: 12.07, date_posted: getMockDate(3), date_updated: getMockDate(3) },
]
